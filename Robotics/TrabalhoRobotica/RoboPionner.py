...
def Simula2(velocidadeAngularRodaDireita,velocidadeAngularRodaEsquerda,Passo=0.05):
    try:
        import sim
    except:
        print ('--------------------------------------------------------------')
    ...
    if clientID!=-1:
        ...
        #Periodo de amostragem e tempo de simulacao
        T = Passo # Tempo de passo. Tem de estar em concordancia com Vrep!
        N = len(velocidadeAngularRodaDireita)
        ...
        for i in range(0,N-1):
            ...
            #Velocidade de referencia
            v_motor_l= velocidadeAngularRodaEsquerda[i]
            v_motor_r= velocidadeAngularRodaDireita[i]
